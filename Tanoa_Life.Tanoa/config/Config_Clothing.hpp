...
class Clothing {
    ...
    class reb {
        ...
        uniforms[] = {
            ...
            { "U_Afghan05", "", 500, "" },
            { "U_Afghan06NH", "", 500, "" },
            { "U_O_T_Soldier_F", "", 2500, "" },
            { "U_O_T_Officer_F", "", 5000, "" },
            { "U_O_T_Sniper_F", "", 7500, "" },
            { "U_O_T_FullGhillie_tna_F_F", "", 10000, "" },
            { "U_O_V_Soldier_Viper_F", "", 12500, "" }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, "" },
            { "H_Shemag_khk", "", 500, "" },
        ...
        vests[] = {
            ...
            { "V_HarnessO_ghex_F", "", 5250, "" },
            { "V_TacVest_khk", "", 7500, "" },
            { "V_TacVest_brn", "", 7500, "" },
            { "V_PlateCarrier1_rgr", "", 12500, "" },
            { "V_PlateCarrier1_tna_F", "", 12500, "" },
            { "V_PlateCarrier2_rgr", "", 17500, "" },
            { "V_PlateCarrierSpec_tna_F", "", 17500, "" }
        };
        backpacks[] = {
            { "NONE", "Remove Backpack", 0, "" },
            { "B_OutdoorPack_blk", "", 500, "" },
