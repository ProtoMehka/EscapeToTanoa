...
class VirtualShops {
    ...
    class cop {
        ...
        side = "cop";
        conditions = "";
        items[] = { "donuts", "coffee", "spikeStrip", "waterBottle", "rabbit", "apple", "redgull", "toolkit", "fuelFull", "defusekit", "gpstracker" };
    };
...
class VirtualItems {
    ...
    class uraniumd {
        variable = "uraniumd";
        displayName = "STR_Item_Uraniumd";
        weight = 5;
        buyPrice = -1;
        sellPrice = 1950;
        illegal = false;
        edible = -1;
        icon = "icons\ico_uraniumd.paa";
    };

    class uraniumb {
        variable = "uraniumb";
        displayName = "STR_Item_Uraniumb";
        weight = 4;
        buyPrice = -1;
        sellPrice = -1;
        illegal = false;
    ...
    class uraniumm {
        variable = "uraniumm";
        displayName = "STR_Item_Uraniumm";
        weight = 4;
        buyPrice = 12000;
        sellPrice = 9500;
        illegal = false;
        edible = -1;
        icon = "icons\ico_uraniumm.paa";
    };

    class isotope {
        variable = "isotope";
        displayName = "STR_Item_Isotope";
        weight = 4;
        buyPrice = -1;
        sellPrice = -1;
        illegal = false;
        edible = -1;
        icon = "icons\ico_isotope.paa";
    };
