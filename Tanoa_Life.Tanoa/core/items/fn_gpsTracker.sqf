...
if(!(_unit isKindOf "AllVehicles")) exitWith {hint "Vous ne pouvez pas utiliser la balise GPS sur ceci."};
...
titleText["Vous avez fixé une balise GPS sur cette cible.","PLAIN"];
...
[_unit] spawn {
    ...
    _marker setMarkerTextLocal "Balise GPS sur un "+getText(configFile >> "CfgVehicles" >> typeof _veh >> "displayName");
